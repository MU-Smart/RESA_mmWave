...
Usage:
    python visualize_radar_on_video_with_seg.py
        ...
        --labeled_csv            "C:\\...\\labeled_radar_points_v3.csv"
        [--alpha_seg 0.35]
        [--point_radius 4]
...
def main():
    ...
    ap.add_argument("--processing_session_dir", required=True,
                    help="Processing session directory (contains seg/, color video)")
    ap.add_argument("--labeled_csv", required=True,
                    help="labeled_radar_points_v3.csv from auto-labeling stage")
    ...
    print(f"  Labels   : {args.labeled_csv}")
