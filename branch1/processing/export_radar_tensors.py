...
from config.config import REPO_ROOT, CFG_PATH_DEFAULT, DATA_ROOT_DEFAULT
...
DATA_ROOT = Path(os.environ.get("RADAR_TENSOR_PROCESSING_ROOT", str(DATA_ROOT_DEFAULT)))
